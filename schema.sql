...
--     -- Added fields to match the form
--     length_mm INT NOT NULL,
--     width_mm INT NOT NULL,
--     thickness_mm INT,
--     is_calibrated BOOLEAN DEFAULT FALSE,
...
--     units ENUM('Pieces', 'Sq Meter') NOT NULL,
...
-- NOTE: Granite and Quartz are left empty as per your screenshots.
...
-- -- Update inventory_transactions to reflect sq_meter as primary unit
-- ALTER TABLE inventory_transactions 
-- MODIFY COLUMN change_in_sq_meter DECIMAL(10, 4) NOT NULL COMMENT 'Primary unit - square meters',
-- MODIFY COLUMN change_in_pieces INT NOT NULL COMMENT 'Derived from sq_meter, always integer',
-- MODIFY COLUMN balance_after_sq_meter DECIMAL(10, 4) NOT NULL COMMENT 'Primary balance in sq_meter',
-- MODIFY COLUMN balance_after_pieces INT NOT NULL COMMENT 'Derived balance in pieces';

-- -- Update procurement_items to use sq_meter as primary
-- ALTER TABLE procurement_items
-- MODIFY COLUMN quantity DECIMAL(10, 4) NOT NULL COMMENT 'Always in square meters',
-- MODIFY COLUMN units ENUM('Sq Meter') NOT NULL DEFAULT 'Sq Meter' COMMENT 'Only sq meter allowed',
-- MODIFY COLUMN rate_unit ENUM('Pieces', 'Sq Meter') NOT NULL COMMENT 'Rate can be per piece or per sq meter';
